...
analysisRoutes.post('/', validateRequest(createAnalysisSchema), createJobAnalysis);
analysisRoutes.get('/', getJobAnalyses);
analysisRoutes.get('/:id', validateRequest(analysisIdSchema), getJobAnalysisById);
analysisRoutes.delete('/:id', validateRequest(analysisIdSchema), removeJobAnalysis);
